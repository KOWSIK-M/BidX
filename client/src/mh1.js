...
import ptm from './images/paytm.jpg';
import vc from './images/vc.jpeg';
import ck from './images/clock.jpg'
...
<<<<<<< HEAD
class Mh1 extends React.Component {
...
=======
    class Mh1 extends React.Component {
        ...
        componentDidMount() {
            ...
            changeColor("#ffffff");
            $('.tmr10241').countdown('2024/03/11 12:00:00', function (event) {
                $(this).html(event.strftime('<h4><i class="days">%D:<span>DAYS</span></i><i class="hours">%H:<span>HRS</span></i><i class="minutes">%M:<span>MIN</span></i><i class="sec">%S<span>SEC</span></i></h4>'));
            });
            $(function () {
    ...
    <a className="glow-on-hover" role="button" href="profile">Profile</a>
    </div>
    <section className="homePage">
                <article className="current wrap">
                    <h1>Auctions available</h1>
                    <span id="ctl00_CPH1_Label1" class="msgNoItm"></span>
                    <div>
                        <ul>
                            <li>
                                <card className="card">
                                <h2><a href="#">Rs. 1000 Paytm Cash</a></h2>
                                
                                <a href="#" className="bgImg" style={{ backgroundImage: `url(${ptm})` }} title="Rs. 1000 Paytm Cash"><span className="hgt"></span></a>
                                <div className="rsPnls" onClick={() => { document.location = ''; }}>
                                    <aside className="time">
                                        <div id="ctl00_CPH1_Datalist2_ctl00_pnlRmngTm" className="time tmr10241">
                                            <h4>
                                                <i className="days">00:<span>DAYS</span></i>
                                                <i className="hours">14:<span>HRS</span></i>
                                                <i className="minutes">10:<span>MIN</span></i>
                                                <i className="sec">47<span>SEC</span></i>
                                            </h4>
                                        </div>
                                    </aside>
                                    <p className="mxp">Max Bid: <b>Rs 200</b></p>
                                    <div className="clear"></div>
                                    <div className="dtlPnl">
                                        <div className="ldr">
                                            <div className="imgPnl"><img alt="Profile Image" src={fb} height="20px"/></div>
                                            <b>satyendra panigrahi<br /><p>Current Leader</p></b>
                                        </div>
                                        <aside className="rgt"><a href="product-details.aspx?pid=10241" className="btn">Bid Now</a></aside>
                                        
                                    </div>
                                    <div className="wins-detail"></div>
                                    </div>
                                    </card>
                            </li>
                        </ul>
                ...
                <article className="current wrap">
                    ...
                    <div>
                        <ul>
                            <li>
                                <card className="card">
                                <h2><a href="#">Vintage Cars</a></h2>
                                
                                <a href="#" className="bgImg" style={{ backgroundImage: `url(${vc})` }} title="Rolls royce"><span className="hgt"></span></a>
                                <div className="rsPnls" onClick={() => { document.location = ''; }}>
                                    <aside className="time">
                                        <div id="ctl00_CPH1_Datalist2_ctl00_pnlRmngTm" className="time tmr10241">
                                            <h4>
                ...
                <article className="current wrap">
                    ...
                    <div>
                        <ul>
                            <li>
                                <card className="card">
                                <h2><a href="#">Anitque Clocks</a></h2>
                                
                                <a href="#" className="bgImg" style={{ backgroundImage: `url(${ck})` }} title="Titan"><span className="hgt"></span></a>
                                <div className="rsPnls" onClick={() => { document.location = ''; }}>
                                    <aside className="time">
                                        <div id="ctl00_CPH1_Datalist2_ctl00_pnlRmngTm" className="time tmr10241">
                                            <h4>
                                    ...
                                    <div className="dtlPnl">
                                        <div className="ldr">
                                            <div className="imgPnl"><img alt="Profile Image" src={ck} height="20px"/></div>
                                            <b>satyendra panigrahi<br /><p>Current Leader</p></b>
                                        </div>
                                        <aside className="rgt"><a href="product-details.aspx?pid=10241" className="btn">Bid Now</a></aside>
...
>>>>>>> d46b126feb1381a04c11186165d709904571e84c
    }
